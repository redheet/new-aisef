...
import bnr1 from '../../../images/main/aisef3.jpg';

const Error404 = () => {
  let resizeMargin = () => {
    var bgImag =
      'background-image: url(' + bnr1 + ');';
    var screenHeight = window.innerHeight;
    document
      .getElementsByClassName('full-height')[0]
      .setAttribute(
        'style',
        bgImag + 'height:' + screenHeight + 'px;'
      );
  };
          ...
          <div className="dlab-bnr-inr-entry align-m">
            <div className="row max-w700 dz_error-404 text-white m-auto">
              ...
              <div className="col-lg-8 m-b30">
                ...
                <p className="font-16">
                  We are sorry but it appears that
                  the page you are looking for
                  could not be found. We are
                  working on it and we will get it
