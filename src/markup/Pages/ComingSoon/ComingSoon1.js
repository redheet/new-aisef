...
import bnr from './../../../images/background/main-coming.gif';

const ComingSoon1 = () => {
  const [timerDays, setTimerDays] =
    useState('00');
  const [timerHours, setTimerHours] =
    useState('00');
  ...
  const startTimer = () => {
    ...
    WebsiteLaunchDate.setMonth(
      WebsiteLaunchDate.getMonth() + 1
    );
    WebsiteLaunchDate =
